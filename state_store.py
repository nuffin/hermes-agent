...
class CompressionCoordinationStore(Protocol):
    ...
    def acquire_session_turn_lease(self, session_id: str, holder: str, *, ttl_seconds: float = 300.0, wait_seconds: float = 1800.0, poll_interval_seconds: float = 1.0, on_wait: Any = None, wait_notice_interval_seconds: float = 15.0, should_abort: Any = None) -> bool: ...
...
class SqliteStateStore:
    ...
    def acquire_session_turn_lease(self, session_id: str, holder: str, **kwargs: Any) -> bool: return self._session_db.acquire_session_turn_lease(session_id, holder, **kwargs)
