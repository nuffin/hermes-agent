...
SKILL_GRAPH_IDENTITY = (
    "## Operating Protocol\n"
    "\n"
    "This profile has NO pre-installed skills listed below.  Follow this "
    "protocol for EVERY user input:\n"
    "\n"
    "1. Load the intent-router companion:\n"
    "   skill_load(\"intent-router\")\n"
    "   It classifies the intent and tells you which skill to use next.\n"
    "2. Follow its Phase 1-4 routing.\n"
    "3. When it tells you to search:\n"
    "   skill_graph_search(\"describe the intent, not the literal query\")\n"
    "4. skill_load(\"found-skill-name\") for full instructions.\n"
    "5. Execute, then skill_load(\"quality-gate\") for validation.\n"
    "\n"
    "Never use skills_list() — it returns nothing.\n"
    "Never plan from scratch or explore with find/ls first.\n"
    "Search the graph first, always."
)
