...
VALID_HOOKS: Set[str] = {
    ...
    # Note: the patching plugin must implement its own find-and-replace logic.
    ...
    # Kwargs: name
    # NOTE: During the curator consolidation pass (background review), the
    # default delete path routes through archive_skill() for recoverability.
    # A plugin that returns "handled" takes full responsibility.
    "pre_skill_delete",
}
