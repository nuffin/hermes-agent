...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("session-topic", "Manage model-history topics inside this CLI session", "Session",
               aliases=("session-topics",), args_hint="[on|off|list|new <name>|switch <id>]",
               cli_only=True),
    ...
    CommandDef("project-scope", "List, explicitly activate, or revoke a session project approval scope",
               "Configuration", args_hint="[list|activate <template-id>|confirm <token>|grant-kanban <board> <card>|confirm-kanban <token>|revoke]",
               subcommands=("list", "activate", "confirm", "grant-kanban", "confirm-kanban", "revoke"), busy_policy="dispatch"),
