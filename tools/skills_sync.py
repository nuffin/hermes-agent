...
def _write_manifest(entries: Dict[str, str]):
    """Write the manifest atomically in v3 format (name:mode:hash).

    The shared writer preserves an existing manifest's permissions while
    retaining v1/v2 compatibility and recording symlink installs distinctly.
    """
