...
metadata:
  hermes:
    related_skills: [subagent-driven-development, plan, test-driven-development, github, github-code-review]
    scenes: [coding]
    tags: [code-review, security, verification, quality, pre-commit, auto-fix, static-analysis, testing]
---
